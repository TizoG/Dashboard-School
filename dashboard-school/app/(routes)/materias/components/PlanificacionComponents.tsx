...
export const PlanificacionComponents = () => {
  ...
  return (
    <div className="mb-6 ">
      <h2 className="text-xl font-bold text-gray-900">Planificaión</h2>
            ...
            >
              <div className="flex gap-6 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-gray-500">{nota.asignatura}</p>
              ...
              <span
                className={`text-xs font-medium  py-1 px-2 rounded-full absolute right-2 top-2 ${
                  nota.prioridad.toLowerCase() === "alta"
                    ...
                    : nota.prioridad.toLowerCase() === "media"
                    ? "bg-orange-200 text-white"
                    : nota.prioridad.toLowerCase() === "baja"
