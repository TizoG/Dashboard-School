...
export const PostNote = ({ onNotaCreada, titulo }: PostNoteProps) => {
    ...
    return (
        <>
            <LiquidButton
                className="cursor-pointer flex items-center gap-2 px-4 py-2 text-amber-800  rounded-lg hover:bg-opacity-90 transition-all duration-200 font-medium shadow-sm hover:shadow-md"
            ...
            <Dialog open={Open} onClose={() => setOpen(false)}>
                ...
                <DialogPanel>
                    ...
                    <div>
                        ...
                        <Input
                            type="text"
                            placeholder="Introduce el titulo de la asignatura"
                            value={asignatura}
